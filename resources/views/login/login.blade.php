				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" action="{{url('shop')}}" method="post">
								@csrf
								...
								<div class="logined">
									...
									<input type="submit" class="sui-btn btn-block btn-xlarge btn-danger" value="登&nbsp;&nbsp;录"><input type="submit" class="sui-btn btn-block btn-xlarge btn-danger" value="&nbsp;git&nbsp;">
								</div>
							</form>
							<div class="otherlogin">
								<div class="types">
									<ul>
										...
										<li><img class="dl" src="/layui/img/github.png" /></li>
									</ul>
								</div>
