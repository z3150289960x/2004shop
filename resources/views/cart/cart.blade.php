...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/layui/css/pages-cart.css" />
</head>
		...
		<div class="allgoods">
						...
						<div class="cart-list">
							<ul class="goods-list yui3-g">
								...
								<li class="yui3-u-11-24">
									<div class="good-item">
										<div class="item-img"><img src="/upload/{{$data->goods_img}}" width="60px" height="100"/></div>
										<div class="item-msg">{{$data->goods_name}}</div>
									</div>
								</li>
								
								<li class="yui3-u-1-8"><span class="price">{{$data->shop_price}}</span></li>
								<li class="yui3-u-1-8">
									<a href="javascript:void(0)" class="increment mins">-</a>
									<input autocomplete="off" type="text" value="1" minnum="1" class="itxt" />
									<a href="javascript:void(0)" class="increment plus">+</a>
								</li>
								<li class="yui3-u-1-8"><span class="sum">{{$data->shop_price}}</span></li>
								<li class="yui3-u-1-8">
									<a href="#none">删除</a><br />
			...
			<div class="cart-tool">
				...
				<div class="toolbar">
					...
					<div class="sumprice">
						<span><em>总价（不含运费） ：</em><i class="summoney">¥{{$data->shop_price}}</i></span>
						{{--<span><em>已节省：</em><i>-¥20.00</i></span>--}}
					</div>
					<div class="sumbtn">
						{{--<a href="{{url('lll' . $data->goods_id)}}">1111</a>--}}
						<a class="sum-btn" href="{{url('pay')}}" target="_blank">结算</a>
					</div>
				</div>
			</div>
